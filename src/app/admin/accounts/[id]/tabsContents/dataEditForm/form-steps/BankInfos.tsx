...
export default function BankInfos({
  ...
  const accountValue =
    account.rd_account_meta.account_bank_account &&
    account.rd_account_meta.account_bank_account_digit
      ? account.rd_account_meta.account_bank_account +
        '-' +
        account.rd_account_meta.account_bank_account_digit
      : '';
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-1">
            <select
              ...
              defaultValue={account.rd_account_meta.account_bank_number}
            >
              <>
                {banks.map((bank) => {
                  return (
        ...
        <div className="sm:col-span-2">
          ...
          <div className="mt-1">
            <input
              ...
              defaultValue={account.rd_account_meta.account_bank_agency}
            ></input>

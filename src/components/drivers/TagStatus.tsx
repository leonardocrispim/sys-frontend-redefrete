export default function TagStatus({
  ...
  const colorClasses: any = {
    EM_ANALISE: 'ring-rede-blue-300/90 text-rede-blue-300/90 bg-rede-blue-800/50',
    ...
    NAO_CONSULTADO: 'ring-rede-gray-300/90 text-rede-gray-200/90 bg-rede-gray-600',
    PENDENTE: 'ring-rede-blue-300/90 text-rede-blue-300/90 bg-rede-blue-800/50',
    ACORDO: 'ring-rede-green-300/90 text-rede-green-300/90 bg-rede-green-800',
    REQUER_ATENÇAO: 'ring-rede-red-300/90 text-rede-red-300/90 bg-rede-red-800',
  };
